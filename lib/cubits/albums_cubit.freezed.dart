...
class _$_InitialAlbumsState implements _InitialAlbumsState {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _InitialAlbumsState);
  }
...
class _$_LoadingAlbumsState implements _LoadingAlbumsState {
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _LoadingAlbumsState);
  }
...
class _$_SuccessAlbumsState implements _SuccessAlbumsState {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _SuccessAlbumsState &&
            (identical(other.albumPhotos, albumPhotos) ||
  ...
  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(albumPhotos);
...
abstract class _SuccessAlbumsState implements AlbumsState {
  ...
  List<AlbumPhotos> get albumPhotos => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  _$SuccessAlbumsStateCopyWith<_SuccessAlbumsState> get copyWith =>
      throw _privateConstructorUsedError;
}
